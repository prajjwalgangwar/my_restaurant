...
{
  //Categories
  static List<String> categories=['North Indian', 'Italian', 'Mexican', 'Chinese', 'Thai', 'South Indian', 'American', 'Greece', 'Japanese', 'Fusion'];

  //SubCategories
  static List<String> northIndian=['Indian Rogan Josh', 'Indian Butter Chicken (Murg Makhani)', 'Indian Fish Amritsari', 'Lachcha Paratha', 'Palak Paneer'];
  static List<String> italian=['Caprese Salad with Pesto Sauce', 'Panzenella', 'Bruschetta', 'Pasta Carbonara', 'Margherita Pizza'];
  static List<String> mexican=['Burritos with Minced Meat Filling', 'Chicken Quesadillas'];
  static List<String> chinese=['Dim Sums', 'Hot and Sour Soup', 'Noodles', 'Szechwan Chilli Chicken', 'Spring Rolls'];
  static List<String> thai= ['Thai Chicken Satay', 'Thai Mini Shrimp Lettuce Wraps', 'Tom Khaa', 'Thai Green Curry', 'Thai Panang Curry'];
  static List<String> southindian=['Dosa', 'Idli', 'Vada', 'Uttapam', 'Pesarattu'];
  static List<String> japanese=['Sushi', 'Sashimi', 'Tempura', 'Soba - Buckwheat Noodles', 'Udon - Hearty Wheat Noodles'];
  static List<String> american=['Apple Pie', 'The Hamburger', 'Tacos', 'Fajitas', 'Cornbread'];
  static List<String> greece=['Taramasalata', 'Moussaka', 'Grilled meat', 'Courgette balls', 'Feta & cheeses'];
  static List<String> fusion=['Thandai Rabdi','KoJa with Kamikaze Fries'];

  //Categories to SubCategories
  Map<String, List<String>> catToSubCat={
  ...
  //SubCategories to Details
  static Map<List<String>, Map<String, List<String>>> subCatToDetails={
    northIndian : northIndianDetails,
    italian : italianDetails,
    mexican : maxicanDetails,
    chinese : chineseDetails,
    thai : thaiDetails,
    southindian : southIndiaDetails,
    american : americanDetails,
    greece : greeceDetails,
    japanese : japaneseDetails,
    fusion : fusionCuisinDetails

  };
  static Map<String,List<String>> northIndianDetails={
    'Indian Butter Chicken (Murg Makhani)' : ['Indian Butter Chicken (Murg Makhani)', '300', 'https://www.thespruceeats.com/thmb/UMESFzKDbBIfL-g4gYddJd4T1zA=/3156x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/authentic-butter-chicken-1957382-Hero-5b61b398c9e77c0050160f54.jpg'],
  ...
  static Map<String, List<String>> americanDetails={
  ...
  static Map<String, List<String>> italianDetails={
  ...
  static Map<String, List<String>> southIndiaDetails={
  ...
  static Map<String, List<String>> maxicanDetails={
  ...
  static Map<String, List<String>> chineseDetails={
  ...
  static Map<String, List<String>> thaiDetails={
  ...
  static Map<String, List<String>> greeceDetails={
  ...
  static Map<String, List<String>> japaneseDetails={
  ...
  static Map<String, List<String>> fusionCuisinDetails={
  ...
  static Map<String, List<String>> cartCardDetails;
